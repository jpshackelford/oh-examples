...
| [custom-agent-with-tool](./custom-agent-with-tool/) | Create a custom tool using the OpenHands SDK (Action/Observation/Executor pattern + shows deployment via automation tarball) |
